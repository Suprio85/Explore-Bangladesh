...
const Dashboard = () => {
    return ( 
        <div className='relative w-full h-screen bg-slate-900'>
            ...
            <div>
                <div className='absolute flex justify-center items-center w-2/3 h-full px-20 bg-opacity-50 left-0 top-0 animate-_right '>
                    <div className='bg-white min-h-96 w-full rounded-xl'>
HELLo
                    </div>
                </div>
            </div>
