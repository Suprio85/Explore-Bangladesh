        ...
        <div className='w-44 h-96  relative group overflow-hidden hover:cursor-pointer hover:animate-growBig' style={{height:'500px'}}>
            <div className=' h-full w-full bg-slate-400'>
                <div className='text-white flex flex-col justify-center items-center w-full absolute bottom-20  z-20 '>
                    <div className='relative -bottom-16 bg-red-300 text-2xl font-bebasNeue group-hover:animate-glowUp'>{category.categoryName}</div>
                    <div className='relative px-20 bg-red-600  -bottom-28 group-hover:block hidden text-lg font-anek group-hover:animate-glowUp'>{category.categoryDescription}</div>
