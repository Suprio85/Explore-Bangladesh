    ...
    return (
        <div className='w-44 h-96  relative group overflow-hidden hover:cursor-pointer hover:animate-growBig' style={{height:'500px'}}>
            <div className=' h-full w-full bg-slate-400'>
                ...
                <div className='w-full h-full object-cover absolute hover:opacity-0 top-0'><img src={category.categoryImage} alt='Image' className='w-full h-full object-cover'></img></div>
            </div>
            <div className=''>
