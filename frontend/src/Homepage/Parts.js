...
const Categorycard = ({ category }) => {
    ...
    return (
        <div className='w-44 h-96  relative group overflow-hidden hover:cursor-pointer hover:animate-growBig group' style={{height:'500px'}}>
            <div className=' h-full w-full bg-slate-400'>
                <div className='text-white flex flex-col justify-center items-center w-full absolute bottom-20  z-20 '>
                    ...
                    <div className='relative px-20 text-center -bottom-28 group-hover:block hidden text-lg font-anek group-hover:animate-glowUp'>{category.categoryDescription}</div>
                ...
                <div className='w-full h-full object-cover absolute bg-slate-900  top-0'><img src={category.categoryImage} alt='Image' className='w-full h-full object-cover group-hover:opacity-50'></img></div>
            </div>
            <div className=''>
